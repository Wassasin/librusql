...
my @tests = qw(test_compile test_connect test_query test_placeholders test_optional test_multiconnection test_signedness test_insert_id test_iterate test_threads test_named_bind);
